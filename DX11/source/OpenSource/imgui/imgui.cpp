...
//! It is recomend_ed that you don't modify imgui.cpp! It will become difficult for you to update the library.
...
/*
 ...
 - Add the Dear ImGui source files to your projects or using your preferred build system.
   It is recomend_ed you build and statically link the .cpp files as part of your project and not as shared library (DLL).
 ...
 - 2017/11/18 (1.53) - Style, Begin: removed ImGuiWindowFlags_ShowBorders window flag. Borders are now fully set up in the ImGuiStyle structure (see e.g. style.FrameBorderSize, style.WindowBorderSize). Use ImGui::ShowStyleEditor() to look them up.
                       Please note that the style system will keep evolving (hopefully stabilizing in Q1 2018), and so custom styles will probably subtly break over time. It is recomend_ed you use the StyleColorsClassic(), StyleColorsDark(), StyleColorsLight() functions.
 ...
 - 2015/01/11 (1.30) - big font/image API change! now loads TTF file. allow for multiple fonts. no need for a PNG loader.
              (1.30) - removed GetDefaultFontData(). uses io.Fonts->GetTextureData*() API to retrieve uncompressed pixels.
                       ...
                       it is now recomend_ed that you sample the font texture with bilinear interpolation.
...
void ImGui::NewFrame()
{
    ...
    if (g.IO.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
    {
        ...
        {
            IM_ASSERT((g.FrameCount == 0 || g.FrameCount == g.FrameCountPlatforend_ed) && "Forgot to call UpdatePlatformWindows() in main loop after EndFrame()? Check examples/ applications for reference.");
...
void ImGui::UpdatePlatformWindows()
{
    ...
    IM_ASSERT(g.FrameCountPlatforend_ed < g.FrameCount);
    g.FrameCountPlatforend_ed = g.FrameCount;
    if (!(g.ConfigFlagsCurrFrame & ImGuiConfigFlags_ViewportsEnable))
        return;
